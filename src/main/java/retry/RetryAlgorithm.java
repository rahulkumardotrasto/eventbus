...
import exception.RetryLimitExceededExcepttion;
...
public abstract class RetryAlgorithm<PARAMETER, RESULT> {
    ...
    public RetryAlgorithm(final int maxAttempts, final Function<Integer, Long> retryTimeCalculator){
        ...
        try {
            ...
            if(e.getCause() instanceof RetryAbleException){
                if(attempts == maxAttempts){
                    throw new RetryLimitExceededExcepttion();
                } else {
